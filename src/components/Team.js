...
export const Team = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-sm tracking-wide text-gray-800">
              Front-end focused developer. Currently learning about blockchain. Lover of architecture, books and miniature dachshunds <span className='text-lg'>🐶</span>
            </p>
        ...
        <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            <p className="text-lg font-bold">Marie-Terese Völker</p>
            <p className="mb-4 text-xs text-gray-800">Designer</p>
            <p className="mb-4 text-sm tracking-wide text-gray-800">
              Student of Communication Design. Creativity is her passion. Marie-Terese only needs a blank sheet of paper and pen to be happy <span className='text-lg'>😊</span>
            </p>
            <div className="flex items-center space-x-3">
              <a
      ...
      //     <p className="mb-4 text-xs text-gray-800">Developer</p>
      //     <p className="mb-4 text-sm tracking-wide text-gray-800">
      //       3rd year Computing Student from Glasgow. Loving front-end development right now. Book Nerd 🤓. Proud lover of Musicals 💃.
      //     </p>
      //     <div className="flex items-center space-x-3">
      //       <a
      //         href="/"
